...
#this function is to display the login page for the doctor
@doctor_routes.route("/doctorloginpage")
def doctor_loginpage():
    return render_template("doctorspage.html")

#this function is to display the page to add doctors
@doctor_routes.route("/add_doctors")
def add_doctorpage():
    return render_template("add_doctors.html")

#this function is to handle the login functionality of the doctor
...
#this function is to handle the register functionality of the doctor
...
# this function is to display the dashboard of the doctor
