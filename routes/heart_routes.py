...
#this function is for the lasso algorithm to allow the system to automatically select important features
...
def lasso_heart():
    ...
    try:
        ...
        # train all features to get importance
        ...
        # Save selected features with the target
...
#this function is to train the model using the selected features by the administrator
...
# this function is to display the prediction form to the patient
@heart_routes.route("/heartdisease")
def heart_disease():
    return render_template("heartdisease.html")


#this function is to upload the heart disease dataset
...
#this function is to get all the patient data
...
# this function is to get the contributions each feature has to the prediction result. 
...
#this function is to predict whether the patient has the disease or not.
...
#this function is for the doctor to view all the patient results.
...
#this function is for the doctor to view how much each feature in the patient contributed towards the prediction result.
...
#this function is for the doctor to view the symptoms of the patient. 
...
#this function is for the doctor to update the diagnosis result of the patient.
...
def update_diagnosis():
    ...
    if send_to_patient:
        ...
        diagnosis_text = "Positive for heart disease please book an appointment to see Dr Patterson immediately using our online booking portal" if final_diagnosis == '1' else "Negative for heart disease" if final_diagnosis == '0' else "Further testing required. Please visit the clinic for additional evaluation."
...
@heart_routes.route("/sendexplanation", methods=["POST"])
def send_explanation():
    ...
    explanation = f"Hello\n\n"
    explanation += "Here is your heart disease risk analysis:\n\n"

    for c in contributions:
        if c['effect'] == "increased":
            explanation += f"- Your {c['feature']} is **high**, which may increase your heart disease risk.\n"
        elif c['effect'] == "lowered":
            explanation += f"- Your {c['feature']} is **low**, which may lower your heart disease risk.\n"
        else:
            explanation += f"- Your {c['feature']} has **no significant effect** on heart disease risk.\n"
...
@heart_routes.route("/view_explanation")
